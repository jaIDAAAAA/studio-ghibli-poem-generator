...
function makePoem(event) {
	...
	let context =
		"you are an inspirational poet who loves to write. Your instructions are to create a four-line poem about Studio Ghibli movies and characters in basic HTML. Please follow the user instructions";
